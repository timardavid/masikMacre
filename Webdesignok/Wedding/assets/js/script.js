...
function updateGallery() {
    ...
    weddingData.gallery.forEach(image => {
        ...
        galleryItem.innerHTML = `
            <img src="assets/images/gallery/${image.filename}" alt="${image.alt_text}" loading="lazy">
...
function updateContactInfo() {
    ...
    if (bridePhone) bridePhone.textContent = `Elena: ${contact.bride_phone}`;
    if (groomPhone) groomPhone.textContent = `Marcus: ${contact.groom_phone}`;
...
// Countdown frissítése dinamikus dátummal
