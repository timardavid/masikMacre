    ...
    if (contactForm) {
        contactForm.addEventListener('submit', async (e) => {
            ...
            if (!data.name || !data.email || !data.subject || !data.message) {
                showFormMessage('Kérlek töltsd ki az összes kötelező mezőt!', 'error');
                return;
            }
            ...
            if (!emailRegex.test(data.email)) {
                showFormMessage('Kérlek adj meg egy érvényes email címet!', 'error');
                return;
            }
            ...
            try {
                ...
                // Success
                showFormMessage('Köszönjük az üzeneted! Hamarosan jelentkezünk.', 'success');
                contactForm.reset();
                ...
                showFormMessage('Hiba történt az üzenet küldése során. Kérlek próbáld újra később!', 'error');
...
console.log(
    '%c🚀 JDW %c- Professzionális Webdesign Megoldások',
...
console.log('%cWeboldal sikeresen betöltve! ✅', 'color: #10b981; font-size: 14px; font-weight: bold;');
