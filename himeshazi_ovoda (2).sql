...
CREATE TABLE `annual_program_items` (
  ...
  `school_year` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `month` tinyint UNSIGNED DEFAULT NULL,
  `section_title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `details` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `enrollment_info` (
  `id` int UNSIGNED NOT NULL,
  `school_year` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `period_text` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `status` enum('hamarosan','folyamatban','lezarult') CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT 'hamarosan',
  `notice` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `documents` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `mandatory_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `optional_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `signature_place_date` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `signature_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `signature_title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `menu_days` (
  ...
  `day_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `day_date` date NOT NULL,
  `day_order` tinyint UNSIGNED NOT NULL,
  `tizorai_items` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `tizorai_allergens` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `tizorai_nutrition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `ebed_items` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `ebed_allergens` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `ebed_nutrition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `uzsonna_items` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `uzsonna_allergens` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `uzsonna_nutrition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `total_nutrition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `menu_days` (`id`, `menu_week_id`, `day_name`, `day_date`, `day_order`, `tizorai_items`, `tizorai_allergens`, `tizorai_nutrition`, `ebed_items`, `ebed_allergens`, `ebed_nutrition`, `uzsonna_items`, `uzsonna_allergens`, `uzsonna_nutrition`, `total_nutrition`, `created_at`, `updated_at`) VALUES
(1, 1, 'Hétfő', '2025-11-03', 1, '[\"Tej, karamellás\", \"Sertés párizsi\", \"Vajkrém\", \"TK Fehérkenyér\", \"Paradicsom\"]', 'L, G, L, T, O, S, K', '{\"C\": 5.3, \"E\": 303.0, \"F\": 10.3, \"S\": 0.9, \"T\": 6.2, \"CH\": 36.9, \"Ca\": 139.5, \"ZS\": 11.8}', '[\"Csibejó leves\", \"Nudli morzsás\"]', 'G, L, T, Z, M, G, T, L, O, S, K', '{\"C\": 23.7, \"E\": 452.0, \"F\": 18.2, \"S\": 0.2, \"T\": 0.1, \"CH\": 77.0, \"Ca\": 44.5, \"ZS\": 6.5}', '[\"Fatörzs kifli\", \"Alma\"]', 'G, L, T', '{\"C\": 3.2, \"E\": 198.0, \"F\": 4.7, \"S\": 0.6, \"T\": 1.2, \"CH\": 27.8, \"Ca\": 11.0, \"ZS\": 3.9}', '{\"C\": 32.3, \"E\": 953.0, \"F\": 33.3, \"S\": 1.7, \"T\": 7.5, \"CH\": 141.8, \"Ca\": 195.0, \"ZS\": 22.1}', '2025-10-31 14:32:38', '2025-10-31 14:32:38'),
(2, 1, 'Kedd', '2025-11-04', 2, '[\"Tea citromos\", \"Tojáskrém\", \"Fehér kenyér\", \"Kígyóuborka\"]', 'T, M, L, G, L, T, O, S, K', '{\"C\": 0.2, \"E\": 264.0, \"F\": 7.5, \"S\": 0.5, \"T\": 0.4, \"CH\": 47.3, \"Ca\": 60.4, \"ZS\": 4.1}', '[\"Tarhonyaleves\", \"Sertés aprópecsenye\", \"Rizibizi\"]', 'G, T, L, Z, M, G, L, T, Z, M', '{\"C\": 0.5, \"E\": 527.0, \"F\": 23.4, \"S\": 0.1, \"T\": 0.3, \"CH\": 55.0, \"Ca\": 32.2, \"ZS\": 23.3}', '[\"Kocka sajt\", \"TK Bagett\"]', 'L, G, L', '{\"C\": 3.8, \"E\": 301.0, \"F\": 13.4, \"S\": 0.6, \"T\": 4.3, \"CH\": 28.1, \"Ca\": 495.0, \"ZS\": 14.7}', '{\"C\": 4.5, \"E\": 1092.0, \"F\": 44.2, \"S\": 1.1, \"T\": 5.0, \"CH\": 130.4, \"Ca\": 587.6, \"ZS\": 42.2}', '2025-10-31 14:32:38', '2025-10-31 14:32:38'),
(3, 1, 'Szerda', '2025-11-05', 3, '[\"Tej\", \"Vajas-Sajtos Kenyér\", \"Paradicsom\"]', 'L, G, L, T, O, S, K', '{\"C\": 4.9, \"E\": 241.0, \"F\": 10.4, \"S\": 0.6, \"T\": 4.1, \"CH\": 27.3, \"Ca\": 217.8, \"ZS\": 9.1}', '[\"Zeller krémleves\", \"Húsos tészta\"]', 'G, L, T, Z, M, G, T, L, Z, M, O', '{\"C\": 6.4, \"E\": 599.0, \"F\": 12.4, \"S\": 0.4, \"T\": 1.5, \"CH\": 55.1, \"Ca\": 125.5, \"ZS\": 14.5}', '[\"Csirkemell sonka\", \"Delma Multivitaminos\", \"TK Rozskenyér\", \"Paprika\"]', 'T, G, L, T, O, S, K', '{\"C\": 0.4, \"E\": 150.0, \"F\": 6.5, \"S\": 0.7, \"T\": 1.6, \"CH\": 16.2, \"Ca\": 16.0, \"ZS\": 5.8}', '{\"C\": 11.7, \"E\": 990.0, \"F\": 29.4, \"S\": 1.7, \"T\": 7.2, \"CH\": 98.7, \"Ca\": 359.3, \"ZS\": 29.4}', '2025-10-31 14:32:38', '2025-10-31 14:32:38'),
(4, 1, 'Csütörtök', '2025-11-06', 4, '[\"Tea\", \"Tonhalkrém\", \"Fehér kenyér\", \"Kígyóuborka\"]', 'G, L, T, Z, H, O, D, G, L, T, O, S, K', '{\"C\": 0.1, \"E\": 262.0, \"F\": 14.1, \"S\": 0.6, \"T\": 0.6, \"CH\": 46.9, \"Ca\": 13.6, \"ZS\": 5.4}', '[\"Gyümölcsleves\", \"Vagdaltpogácsa sertéshúsból\", \"Felesborsó főzelék\"]', 'G, L, G, L, T, O, S, K, Z, M, G, L, T, Z, M', '{\"C\": 16.7, \"E\": 481.0, \"F\": 6.2, \"S\": 0.1, \"T\": 0.6, \"CH\": 51.1, \"Ca\": 45.7, \"ZS\": 5.5}', '[\"Joghurt, gyümölcsös\", \"TK Kifli\"]', 'L, G, L', '{\"C\": 5.4, \"E\": 168.0, \"F\": 5.9, \"S\": 0.5, \"T\": 0.5, \"CH\": 26.9, \"Ca\": 85.0, \"ZS\": 0.8}', '{\"C\": 22.2, \"E\": 911.0, \"F\": 26.2, \"S\": 1.3, \"T\": 1.6, \"CH\": 124.9, \"Ca\": 144.3, \"ZS\": 11.7}', '2025-10-31 14:32:38', '2025-10-31 14:32:38'),
(5, 1, 'Péntek', '2025-11-07', 5, '[\"Tea gyümölcsös\", \"Vajas-Lekváros Kenyér\"]', 'G, L, T, O, S, K', '{\"C\": 15.9, \"E\": 289.0, \"F\": 4.5, \"S\": 0.5, \"T\": 1.3, \"CH\": 53.8, \"Ca\": 13.0, \"ZS\": 5.0}', '[\"Frankfurti leves\", \"Rántott sajt\", \"Zöldséges bulgur\"]', 'T, O, L, G, Z, M, L, T, G', '{\"C\": 3.5, \"E\": 497.0, \"F\": 20.0, \"S\": 0.7, \"T\": 5.9, \"CH\": 60.5, \"Ca\": 312.0, \"ZS\": 18.5}', '[\"Ausztria szalámi\", \"Delma Multivitaminos\", \"Vágott Zsemle\", \"Paprika\"]', 'G, L, T, O, S, K', '{\"C\": 0.2, \"E\": 234.0, \"F\": 8.3, \"S\": 0.6, \"T\": 4.5, \"CH\": 28.6, \"Ca\": 9.0, \"ZS\": 13.2}', '{\"C\": 19.6, \"E\": 1020.0, \"F\": 32.8, \"S\": 1.8, \"T\": 11.7, \"CH\": 143.0, \"Ca\": 334.0, \"ZS\": 36.7}', '2025-10-31 14:32:38', '2025-10-31 14:32:38');

-- --------------------------------------------------------

--
-- Table structure for table `menu_weeks`
--
...
CREATE TABLE `menu_weeks` (
  ...
  `group_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL DEFAULT 'Óvodás (4-6 év)',
  `location` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT 'Himesháza',
  `active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
--
-- Dumping data for table `menu_weeks`
--

INSERT INTO `menu_weeks` (`id`, `start_date`, `end_date`, `group_type`, `location`, `active`, `created_at`, `updated_at`) VALUES
(1, '2025-11-03', '2025-11-07', 'Óvodás (4-6 év)', 'Himesháza', 1, '2025-10-31 14:32:38', '2025-10-31 14:32:38');
...
(3, 'Konyhai kisegítő', 'Werner Józsefné', 0, 3),
(5, 'Konyhai kisegítő', 'Molnárné Aranyos Erika', 0, 5);
...
CREATE TABLE `roles` (
  ...
  `slug` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
CREATE TABLE `staff_category` (
  `id` int UNSIGNED NOT NULL,
  `slug` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
...
(1, 'ovonok', 'Óvodapedagógusaink', NULL, 1, 1, '2025-09-18 20:14:37', '2025-11-20 18:41:17'),
...
CREATE TABLE `staff_member` (
  ...
  `name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `role_title` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `bio` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `photo_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `email` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `phone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `szolgaltatasok` (
  ...
  `leiras` text CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci,
  `idopont` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `kep_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `szemelyek` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
...
(13, 'Kertész Imre', 'kertesz.imre@gmail.com', 'Teszt', 'Teszt', '2025-11-20 18:23:51', 0, '::1'),
(14, 'Timár Dávid', 'timar.david1974@gmail.com', 'teszt', 'Teszt', '2025-11-20 19:29:03', 0, '::1'),
(15, 'Timár Dávid', 'timar.david1974@gmail.com', 'tesztelek', 'tesztelek', '2025-11-20 19:30:50', 0, '::1'),
(16, 'Timár Dávid', 'timar.david1974@gmail.com', 'teszt', 'teszt', '2025-11-20 19:42:19', 0, '::1'),
(17, 'Timár Dávid', 'timar.david1974@gmail.com', 'te', 'te', '2025-11-22 09:52:10', 0, '::1');
...
ALTER TABLE `menu_days`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_menu_week` (`menu_week_id`),
  ADD KEY `idx_day_date` (`day_date`);

--
-- Indexes for table `menu_weeks`
--
ALTER TABLE `menu_weeks`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `menu_weeks`
--
ALTER TABLE `menu_weeks`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `uzenetek`
  MODIFY `uzenet_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `menu_days`
  ADD CONSTRAINT `fk_menu_days_week` FOREIGN KEY (`menu_week_id`) REFERENCES `menu_weeks` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
